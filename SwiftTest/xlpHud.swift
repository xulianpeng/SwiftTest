...
class xlpHud: UIView {
    ...
    let kViewPading:Int = 10
     ...
     init(text:String,constransY:CGFloat) {
        ...
        aAttritString.addAttributes([NSAttributedString.Key.font:kHudFont,NSAttributedString.Key.paragraphStyle:aStyle], range: NSMakeRange(0, aAttritString.length))
