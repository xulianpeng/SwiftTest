...
//    self.layer.anchorPoint = CGPointMake(0.85, 0);
    NSLog(@"\n1.arrowPoint.x=%f==\n2.arrowPoint.y=%f====\n3.currentW=%f===\n3.self.layer.anchorPoint=====\n4.self.layer.frame.origin.x==%f,\n5.self.layer.position.x==%f,\n6.self.layer.anchorPoint.x==%f,\n7.self.layer.bounds.orgin.x==%f",arrowPoint.x,arrowPoint.y,currentW,self.layer.frame.origin.x,self.layer.position.x,self.layer.anchorPoint.x,self.layer.bounds.origin.x);
    self.frame = oldFrame;
